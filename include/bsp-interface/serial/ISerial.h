...
namespace bsp
{
	...
	public:
		...
		virtual void Open(bsp::serial_property::Direction direction,
						  ...
						  bsp::serial_property::HardwareFlowControl hardware_flow_control) = 0;
		...
		/// @param baud_rate 波特率。
		void Open(bsp::serial_property::BaudRate const &baud_rate);

#pragma region 串口属性
		/// @brief 数据传输方向
		/// @return
		virtual bsp::serial_property::Direction Direction() = 0;
		...
		/// @brief 校验位。
		/// @return
		virtual bsp::serial_property::Parity Parity() const = 0;

		/// @brief 停止位个数。
		/// @return
		virtual bsp::serial_property::StopBits StopBits() const = 0;

		/// @brief 硬件流控。
		/// @return
		virtual bsp::serial_property::HardwareFlowControl HardwareFlowControl() const = 0;
