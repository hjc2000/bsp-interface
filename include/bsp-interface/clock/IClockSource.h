...
#pragma region 参数类
	...
	public:
		explicit IClockSource_TargetOutputFrequency(base::MHz const &value)
		{
			_value = value;
		}

		base::MHz Value() const
		{
			return _value;
		}

		void SetValue(base::MHz const &value)
		{
			_value = value;
		}
	};
...
#pragma region Open
		...
		virtual void Open(base::MHz const &crystal_frequency);
...
#pragma region SetAsBypass
		...
		virtual void SetAsBypass(base::MHz external_clock_frequency);
